...
const Instructions = () => {
  return (
    ...
    <h3>2. The video will be played only once when you click on it</h3>
    <h3>3. Notice the audio and video carefully</h3>
    <h3>4. Report your answer in the text box given right below the video</h3>
    <h3>5. Once you have written the answer, click the next button to move to the next video</h3>
